-- ============================================
-- FIX: Recreate Rekomendasi AI Table
-- ============================================

-- Backup data jika ada (opsional)
CREATE TABLE IF NOT EXISTS rekomendasi_ai_backup AS SELECT * FROM rekomendasi_ai;

-- Drop table lama
DROP TABLE IF EXISTS `rekomendasi_ai`;

-- Create ulang dengan struktur yang benar
...
-- Verifikasi
SELECT 
    'Tabel rekomendasi_ai berhasil direcreate!' AS Status,
...
SELECT 'DONE! Tabel sudah siap digunakan.' AS result;
