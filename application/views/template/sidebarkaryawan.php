...
<aside id="sidebar" class="sidebar w-64 bg-white border-r border-slate-200 min-h-screen flex flex-col fixed left-0 top-0 z-40 transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 shadow-sm">
    ...
    <nav class="flex-1 px-4 py-6 overflow-y-auto">
        ...
        <a href="<?= base_url('karyawan/karyawan_dashboard') ?>"
            class="flex items-center px-4 py-3 rounded-xl mb-2 transition-colors <?= ($segment2 == 'karyawan_dashboard' || $segment2 == '') ? 'bg-emerald-50 text-emerald-600 font-bold dark:bg-emerald-950/50 dark:text-emerald-400' : 'text-slate-600 hover:bg-emerald-50 hover:text-emerald-600 dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-emerald-400' ?>">
