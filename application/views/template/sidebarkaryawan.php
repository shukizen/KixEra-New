...
<button id="mobileMenuBtn" class="fixed top-6 left-4 z-50 bg-white text-slate-800 border border-slate-200 p-3 rounded-lg shadow-sm hover:bg-slate-50 transition-all duration-300 lg:opacity-0 lg:pointer-events-none">
...
<aside id="sidebar" class="sidebar w-64 bg-white border-r border-slate-200 min-h-screen flex flex-col fixed left-0 top-0 z-40 transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 shadow-sm">
    <!-- Logo Area -->
    ...
    <nav class="flex-1 px-4 py-6 overflow-y-auto">
        <!-- Dashboard -->
        <a href="<?= base_url('karyawan/karyawan_dashboard') ?>"
            class="flex items-center px-4 py-3 rounded-xl mb-2 transition-colors <?= ($segment2 == 'karyawan_dashboard' || $segment2 == '') ? 'bg-emerald-50 text-emerald-600 font-bold' : 'text-slate-600 hover:bg-emerald-50 hover:text-emerald-600' ?>">
            <i class="fas fa-chart-line mr-3"></i>
            Dashboard
        </a>

        <!-- Pesanan -->
        <a href="<?= base_url('karyawan/pesanan') ?>"
        ...
        <!-- Pelanggan -->
        <a href="<?= base_url('karyawan/pelanggan') ?>"
        ...
        <!-- Pengaturan -->
        <a href="<?= base_url('karyawan/pengaturan') ?>"
