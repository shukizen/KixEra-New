...
<!-- Page Header -->
<header class="bg-white rounded-2xl shadow-lg p-6 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border border-gray-100">
    <div>
    ...
    <a href="<?= base_url('karyawan/inventori') ?>" class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl transition-all duration-300 flex items-center gap-2 shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40 hover:-translate-y-0.5">
...
<div class="bg-green-50 border-l-4 border-green-500 text-green-700 px-5 py-4 rounded-xl mb-4 flex items-center shadow-md">
...
<div class="bg-red-50 border-l-4 border-red-500 text-red-700 px-5 py-4 rounded-xl mb-4 flex items-center shadow-md">
...
<div class="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-100">
    ...
    <form method="GET" action="<?= base_url('karyawan/inventori/lihat_stok') ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="flex items-end gap-2">
            <button type="submit" class="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-3 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40 font-medium">
...
<div class="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-100">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <?php if(isset($items_by_category) && !empty($items_by_category)): ?>
            ...
            <div class="border-2 border-gray-200 rounded-xl p-5 hover:border-emerald-400 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 bg-white">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <?php if(isset($inventory) && !empty($inventory)): ?>
                ...
                <tr class="border-t border-gray-100 hover:bg-emerald-50/30 transition-all duration-200">
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form method="POST" action="<?= base_url('karyawan/inventori/update') ?>" id="formEdit">
            ...
            <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
                ...
                <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl transition-all duration-300 font-medium shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40 flex items-center gap-2">
